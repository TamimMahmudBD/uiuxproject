      ...
      <div className='mm:flex mm:justify-center  mm:flex-col mm:items-center sm:flex sm:justify-center sm:flex-col md:flex md:flex-row md:justify-center bgImg'>
        ...
        <div className="mm:text-left sm:text-left md:text-left mm:mx-5 sm:mx-0 lg:mr-32 xl:mr-36">
          <div className='flex mb-0 mm:text-left sm:text-center md:text-left'>
            ...
            <div className=''>
              <span className='text-white font-semibold mm:text-4xl md:text-2xl md:p-2 text-3xl lg:text-2xl ml-4 lg:py-1.5 lg:px-2.5 xl:py-2 xl:px-4 rounded-lg bg-gradient-to-br from-green-600 to-green-950'>UI/UX</span>
            </div>
          </div>
          <div className='-mt-10'>
          ...
          <div className='flex mt-11 md:mt-5 lg:mt-8 lg:items-center mm:flex-col lg:flex-row md:justify-start md:items-start'>
            <div>
              <button className='border-2 px-4 py-2  bg-gradient-to-br text-white font-semibold from-green-600 to-green-950  rounded-md transition duration-500 transform hover:scale-110'><a href="/">
        ...
        <div className='mm:mx-3 sm:mr-10'>
          <div class="w-[349px] lg:w-[249] lg:h-[349] h-[439px] rounded-tl-[311px] rounded-tr-[311px] border-4 pl-4 border-green-300">
            <div class=""> </div><img className='w-[349px] h-[439px] lg:w-[249] lg:h-[349] p-10 pb-0 bg-gradient-to-br from-green-600 to-green-950 rounded-tl-[311px] rounded-tr-[311px]' src={manimg} alt="react logo" /></div>
        </div>
      </div>
    </div>
  )
